...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter-docprovider-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter-docprovider-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter-docprovider
# for installing globally
pixi global install jupyter-docprovider
```
...
It is possible to list all of the versions of `jupyter-docprovider` available on your platform:
...
```
pixi search jupyter-docprovider --channel conda-forge
```
